...
public class AtgNegyNegyedesJelleggorbek extends Applet implements
		ChangeListener {
	...
	public void init() {
		...
		message = new JLabel("Fordulatszám (n/n névl): 0%", JLabel.CENTER);
		...
		label_nominal = new JLabel("Relatív szállítómagasság (H/H_névl)");
		label_nominal.setForeground(Color.BLACK);
		label_actual = new JLabel("Relatív tengelynyomaték (M/M_névl)");
	...
	public void stateChanged(ChangeEvent ce) {
		message.setText("Fordulatszám: " + slider.getValue() + " % ");
		update_curves();
	}
