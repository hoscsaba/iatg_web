...
public class AtgEloperdulet_ENG extends JFrame implements ChangeListener {
	...
	public static void main(String[] args) {
		AtgEloperdulet_ENG app = new AtgEloperdulet_ENG();
        app.init();
    }
	...
	public void init() {
		...
		labelTable.put(new Integer(30), new JLabel("30 deg"));
		// new JLabel(createImageIcon("images/stop.gif")) );
		labelTable.put(new Integer(90), new JLabel("90 deg"));
		labelTable.put(new Integer(120), new JLabel("120 deg"));
		...
		message = new JLabel("Prerotational blade row angle : 90 deg",
				JLabel.CENTER);
		...
		drawing2.setTitle("Inlet velocity triangle:");
